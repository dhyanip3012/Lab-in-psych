...
expName = 'Intentional_binding_7.0'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\123\\OneDrive\\Desktop\\Lab Psychology\\Intentional Binding 7.0\\Intentional_binding_7.0_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key pressed and the beep sound (0-999); Click submit after entering the value',
        font='Arial',
