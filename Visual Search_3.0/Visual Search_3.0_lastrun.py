...
expName = 'Visual Search_3.0'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\123\\OneDrive\\Desktop\\Lab Psychology\\Visual Search_3.0\\Visual Search_3.0_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Welcome to the experiment. Please click on the T that you see on the screen. ',
        font='Arial',
