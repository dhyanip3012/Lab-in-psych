...
expName = 'Word_priming_5.0'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\123\\OneDrive\\Desktop\\Lab Psychology\\Word Priming 5.0\\Word_priming_5.0_lastrun.py',
